...
FILE_STORAGE_PATH = r"D:\\Case Studies\\Scalance S\\Code\\uploads"
...
# =========================
#  File mover variables 
# =========================
# ---- Control nodes for mover ----
transfer_request = file1.add_variable(idx, "TransferRequest", False, ua.VariantType.Boolean)
transfer_request.set_writable()   # so UI/script can set it

requested_file = file1.add_variable(idx, "RequestedFileName", "", ua.VariantType.String)
requested_file.set_writable()     # optional: which file to move; empty = newest

last_status = file1.add_variable(idx, "LastTransferStatus", "", ua.VariantType.String)
last_status.set_writable()

last_time = file1.add_variable(idx, "LastTransferTime", "", ua.VariantType.String)
last_time.set_writable()
